...
files = os.listdir()
if 'siamese_nn.keras' not in files:
...
# 미리 훈련시킨 샴 신경망을 가져온다
model = load_model('siamese_nn.keras', custom_objects={'contrastive_loss': utils.contrastive_loss, 'euclidean_distance': utils.euclidean_distance})
